...
use libp2p::swarm::protocols_handler::{OneShotHandler, ProtocolsHandler, DummyProtocolsHandler};
...
impl <TSubstream> NetworkBehaviour for BitSwap<TSubstream>
 where TSubstream: AsyncRead + AsyncWrite 
 {
     ...
     fn poll(&mut self, _: &mut impl PollParameters) -> Async<NetworkBehaviourAction<<Self::ProtocolsHandler as ProtocolsHandler>::OutEvent, Self::OutEvent>> {
         unimplemented!()
     }
 }